...
public class app extends Frame {
	...
	app(String frameText)//constructor  
	{  
	super(frameText);  
...
{  
app cl;  
MyDigitButton(int x,int y, int width,int height,String cap, app clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, app clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
cl.displayLabel.setText(app.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class
...
MySpecialButton(int x,int y, int width,int height,String cap, app clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
